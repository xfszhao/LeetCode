...
[678.Valid-Parenthesis-String](https://github.com/wisdompeak/LeetCode/tree/master/Greedy/678.Valid-Parenthesis-String) (H-) (8/9/21, 1. use lower and upper bound of possible '*' representation - reset lower to 0 when it's < 0, return false when upper<0; 2. two passes; two stack to store the '(' and '*' positions)     
