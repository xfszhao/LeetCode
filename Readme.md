...
1423.Maximum-Points-You-Can-Obtain-from-Cards（E）(9/8/21, AC, 要诀：反过来求最小的Sliding Window Sum；注意：sumCurr和 sumMin的区别和必要性)  
...
[153.Find-Minimum-in-Rotated-Sorted-Array](https://github.com/wisdompeak/LeetCode/tree/master/Binary_Search/153.Find-Minimum-in-Rotated-Sorted-Array) (M+)(AC, 8/21/21)  
...
[456.132-Pattern](https://github.com/wisdompeak/LeetCode/tree/master/Stack/456.132-Pattern) (H-) (8/12/21, leftMin to track min of the left part of array; Scan from right to left; monoStack to track the next bigger element on the right）    
[636.Exclusive-Time-of-Functions](https://github.com/wisdompeak/LeetCode/tree/master/Stack/636.Exclusive-Time-of-Functions) (H-)    
[856.Score-of-Parentheses](https://github.com/wisdompeak/LeetCode/tree/master/Stack/856.Score-of-Parentheses) (M+) (8/11/21, Got stuck, don't know 突破口在哪里）    
[946.Validate-Stack-Sequences](https://github.com/wisdompeak/LeetCode/tree/master/Stack/946.Validate-Stack-Sequences)（H-）(8/11/21, AC, Simulate the process, an index to track the popped array)   
[1190.Reverse-Substrings-Between-Each-Pair-of-Parentheses](https://github.com/wisdompeak/LeetCode/tree/master/Stack/1190.Reverse-Substrings-Between-Each-Pair-of-Parentheses) (H-) (8/11/21, AC, a global stack + a local stack, reset local stack after each loop)  
...
* ``monotonic stack``    
[042.Trapping-Rain-Water](https://github.com/wisdompeak/LeetCode/tree/master/Others/042.Trapping-Rain-Water) (H)(8/14/21, AC, leftMax and rightMax combined)  
...
[739.Daily-Temperatures](https://github.com/wisdompeak/LeetCode/tree/master/Stack/739.Daily-Temperatures)  (H-)(8/12/21, AC, MonoStack to store position and temperature)    
...
[1438.Longest-Continuous-Subarray-With-Absolute-Diff-Less-Than-or-Equal-to-Limit](https://github.com/wisdompeak/LeetCode/tree/master/Deque/1438.Longest-Continuous-Subarray-With-Absolute-Diff-Less-Than-or-Equal-to-Limit) (H) (AC, 9/9/2021, Two deque; 先判断条件再移指针；注意 j go out of bound；multi-set -> O(nlogn); deque only needs to store index!)   
...
[690.Employee-Importance](https://github.com/xfszhao/LeetCode/tree/master/DFS/690.Employee-Importance) (E) (8/24/21, ACed again using DFS)  
...
[1778.Shortest-Path-in-a-Hidden-Grid](https://github.com/wisdompeak/LeetCode/tree/master/DFS/1778.Shortest-Path-in-a-Hidden-Grid) (H-)(8/24/21, reviewed, use DFS to mark the grids, and then BFS to find the shortest path)  
* ``search in an array``    
...
[1810.Minimum-Path-Cost-in-a-Hidden-Grid](https://github.com/wisdompeak/LeetCode/tree/master/BFS/1810.Minimum-Path-Cost-in-a-Hidden-Grid) (M+) (8/24/21, reviewed, DFS to mark the grid, Dijkstra to find the min path cost)  
...
* ``KMP``   
[1392.Longest-Happy-Prefix](https://github.com/wisdompeak/LeetCode/tree/master/String/1392.Longest-Happy-Prefix) (H) (8/26/21, reviewed but not implmented, 如果dp\[i\]=j,那么s\[0:j-1\] = s\[i-j+1:i\])    
...
[547.Friend-Circles](https://github.com/wisdompeak/LeetCode/tree/master/Union_Find/547.Friend-Circles) (M) (AC. 8/19/21; 最后 count的时候需要做一次 find! 因为 path compression并不能 compress先前的 nodes；那么加上或不加上 path compression 的 UF的时间复杂度是什么呢？)    
[200.Number-of-Islands](https://github.com/wisdompeak/LeetCode/tree/master/DFS/200.Number-of-Islands) (H-)    
...
[1970.Last-Day-Where-You-Can-Still-Cross](https://github.com/wisdompeak/LeetCode/tree/master/Union_Find/1970.Last-Day-Where-You-Can-Still-Cross) (H-)([LarryNY的代码](https://www.youtube.com/watch?v=IiXZ2_f6wug&t=663s) 更加易懂；Key: 1) use left and right 2) use seen)    
* ``MST``    
...
[1249.Minimum-Remove-to-Make-Valid-Parentheses](https://github.com/wisdompeak/LeetCode/tree/master/Greedy/1249.Minimum-Remove-to-Make-Valid-Parentheses) (M+) (8/9/21, AC, may use a real Stack to record the extra left parensis positions)\
[1541.Minimum-Insertions-to-Balance-a-Parentheses-String](https://github.com/wisdompeak/LeetCode/tree/master/Greedy/1541.Minimum-Insertions-to-Balance-a-Parentheses-String) (M+) (8/9/21, Bad problem - don't understand why the answer for "(()))(()))()())))" is 4 instead of 1)  
[678.Valid-Parenthesis-String](https://github.com/wisdompeak/LeetCode/tree/master/Greedy/678.Valid-Parenthesis-String) (H-) (8/9/21, AC, 1. use lower and upper bound of possible * representation - reset lower to 0 when it's < 0, return false when upper<0; 2. two passes; two stack to store the '(' and * positions)     
